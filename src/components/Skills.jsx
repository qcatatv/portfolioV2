...
function Skills() {
  return (
    <div className='flex flex-row items-center justify-center content-center gap-5 mt-5'>
        <img className='object-contain h-20 w-auto ' width="144" height="144" src="https://img.icons8.com/color/480/html-5--v1.png" alt="html-5--v1"/>
        <img className='object-contain h-20 w-auto' width="144" height="144" src="https://img.icons8.com/color/144/css3.png" alt="css3"/>
        <img className='object-contain h-20 w-auto' width="144" height="144" src="https://img.icons8.com/color/144/angularjs.png" alt="angularjs"/>
